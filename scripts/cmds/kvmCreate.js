...
exports.command = 'kvm-create <map> <key> <value>'
exports.desc = 'Create KVM value.'
exports.builder = {}
exports.handler = async function (argv) {
  logger.info(`Starting KVM create.`);
  try {
    const value = await requests.postKVMValueRequest(argv.map, {"name": argv.key, "value": argv.value});
