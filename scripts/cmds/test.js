...
exports.command = 'test <path> <query> <header> <body>'
exports.desc = 'Execute test request to Apigee proxy.'
exports.builder = {}
exports.handler = async function (argv) {
  logger.info(`Starting test 1.`);
  try {
    while (true) {
        const test = await requests.testRequest(argv.path, {}, {});
        logger.info(`Endpoint response ${test}.`);            
    }
  }
  catch(error) {
